...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'teacher') {
    $_SESSION['messagesLoginErrors'] = "logged first.";
   ...
   <main class=" w-[80%] m-auto min-h-[140vh] flex items-center ">
    <div class="w-full">
      <section class="bg-white ">
        <h1 class="text-4xl font-bold mb-10 text-yellow-700">Messaging ID framework development for the marketing branch</h1>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="col-span-2">
                <div class="p-6 bg-green-100 rounded-xl">
                  <div class="font-bold text-2xl text-gray-800 leading-none">Good day, <br>Kristin</div>
                  <div class="mt-5">
