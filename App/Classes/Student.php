...
class Student extends User {
    ...
    public function __construct(string $id='',string $name, string $email, string $password,string $role,string $AccountStatus='',string $status='', string $linkGithub='', string $linkLinkedin='', string $phoneNumber='', string $image='') {
